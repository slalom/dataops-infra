...
def lambda_handler(event, context):
    ...
    if ('modelName' in event):
        ...
        raise KeyError('modelName key not found in function input!'+
    ...
    try:
        ...
        logger.info("Training job:{} has status:{}.".format(model_name,
        ...
        print(e)
        print('{} Attempted to read model name: {}.'.format(response, model_name))
